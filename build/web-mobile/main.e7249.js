(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.83fbd.js' : 'src/project.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.3858d.js');
            require(window._CCSettings.debug ? 'cocos2d-js.9ed1d.js' : 'cocos2d-js-min.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.9ed1d.js' : 'cocos2d-js-min.js';
