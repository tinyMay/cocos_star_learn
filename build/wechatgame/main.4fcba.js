(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.b633d.js' : 'src/project.js';
        if (jsList) {
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.071b3.js' : 'cocos2d-js-min.js';
